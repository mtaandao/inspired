...
class Mtaa_Admin_Settings_Fields {
    public $first = true;
    ...
    public function select_layout($args) {
        ...
        foreach ($options as $key => $val) {
            ...
            $out.= "\">";
            $out.= "<img src=\"".Mtaa::$mtaaPath."/assets/images/layout-$key.png\" alt=\"\" title=\"$val\" class=\"layout-select\" /></label>";
        }
    ...
    public function textarea($args) {
        ...
        $value = apply_filters('mtaa_field_' . $id, $value);
    ...
    public function typography($args) {
        ...
        $out.= '<select name="' . $id . '[font-family]" id="' . $id . '-family" class="mtaa-typography-family">';
        ...
        $out.= '<select name="' . $id . '[font-style]" id="' . $id . '-style" class="mtaa-typography-style">';
        ...
        $out.= '<select name="' . $id . '[font-size]" id="' . $id . '-size" class="mtaa-typography-size">';
        ...
        $out.= '<div class="colorSelector"><div></div></div><input name="'.$id.'[font-color]" id="'.$id.'-color" class="txt input-text input-colourpicker mtaa-typography-color" type="text" value="'.$font_color.'"></input>';

        $out.= "<p>$desc</p>";

        $out.= '</div><!-- /div.mtaa-typography -->';
    ...
    public function upload($args) {
        ...
        $out.= "<label>$name</label>";
        $out.= Mtaa_Medialib_Uploader::action($id, $value, $desc);
