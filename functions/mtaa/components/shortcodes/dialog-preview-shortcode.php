...
// Mtaandao automatically adds slashes to quotes
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Mtaa::$assetsPath . '/css/shortcodes.css'; ?>" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo Mtaa::$assetsPath . '/css/font-awesome.min.css'; ?>" media="all" />
    <style>
...
<script type="text/javascript">
    jQuery( '#mnz-preview h3:first', window.parent.document).removeClass('mnz-loading');
</script>
</body>
</html>
