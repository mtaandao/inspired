...
"id3" => array(
    ...
    array("name"  => "Enable SEO Settings",
          "desc"  => "If you want to use a 3rd party SEO Plugin uncheck this option.<br/><strong>Recommended SEO Plugins</strong>: <a href=\"http://mtaandao.org/extend/plugins/all-in-one-seo-pack/\">All in One SEO Pack</a>, <a href=\"http://mtaandao.org/extend/plugins/mtaandao-seo/\">Mtaandao SEO</a> ",
          "id"    => "seo_enable",
          "std"   => "on",
          "type"  => "checkbox"),
    ...
    array("name"  => "Category Archives",
          "id"    => "index_category",
          "desc"  => "The options below will help you prevent the indexing in search engines of unwanted pages that are generated automatically by Mtaandao that do nothing but dilute your search results by adding <code>&lt;noindex&gt;</code> tag.",
...
"framework" => array(
    ...
    array("name"  => "Framework Generator Meta Tags",
          "desc"  => "Includes information about theme and framework you use in meta tags along to Mtaandao ones, they are used just for information and doesn't impact your SEO.",
          "id"    => "meta_generator",
          "std"   => "on",
          "type"  => "checkbox"),
    ...
    array("name"  => "Framework Updater",
          "desc"  => "This enables update features for Mtaa framework such as menu in admin and also global notifications about new updates.",
          "id"    => "framework_update_enable",
          "std"   => "on",
          "type"  => "checkbox"),

    array("name"  => "Framework Updater Notification",
          "desc"  => "Enables or disables global admin notification about new versions of framework. If previous option is disabled this one is irrelevant.",
          "id"    => "framework_update_notification_enable",
          "std"   => "on",
          "type"  => "checkbox"),

    array("name"  => "Themes Updater Notification",
          "desc"  => "Enables or disables global admin notification about new versions of theme.",
          "id"    => "framework_theme_update_notification_enable",
          "std"   => "on",
          "type"  => "checkbox"),

    array("name"  => "New Themes Page",
          "desc"  => "Enables or disables page with all Mtaa themes and displays a link to it under Mtaa menu.",
          "id"    => "framework_newthemes_enable",
          "std"   => "on",
          "type"  => "checkbox"),

    array("name"  => "Enable Mtaa Shortcodes",
          "desc"  => "This enables the output of shortcodes.css in the HEAD section of your site.",
          "id"    => "framework_shortcodes_enable",
          "std"   => "on",
          "type"  => "checkbox"),

    array("name"  => "Enable Mtaa Slideshow Shortcode",
    ...
    array("name"  => "Debug info",
          "desc"  => "You can include this information in your support posts on Mtaa Support Forum.",
          "id"    => "misc_debug",
          "std"   => "",
          "type"  => "textarea"),
),
