function mnzColumnMaker(h, i, f) {
    ...
    this.buildSelectControl = function () {
        ...
        this.selectControl = jQuery( "<select></select>").attr( "id", "mnz-column-select").addClass(f ? f : "" );
    ...
    this.buildTextControl = function () {
        ...
        this.textControl = jQuery( "<div>&nbsp;</div>").attr( "id", "mnz-column-text").attr( "style", "width: " + (this.width - 50) + "px" );
    ...
    this.buildColumnButtons = function (a) {
        if (this.buttonsControl) {
            ...
            this.buttonsControl = jQuery( "<div></div>").attr( "id", "mnz-column-buttons" );
