...
jQuery(document).ready(function($) {
    ...
    $(".wz-parent > a").click(function() {
        ...
        $("#mtaaWrap .tabs .sub").removeClass('active');
        $("#mtaaWrap .tabs ul").slideUp('fast');
...
jQuery(document).ready(function($) {
    $("#misc_load_default_widgets").click(function(e) {
        ...
        var loading = $("#mtaaLoading");
        var success = $("#mtaaSuccess");
        var fail    = $("#mtaaFail");
        ...
        $.post(mtaa_ajax_url, data, function(response) {
            if (response.success) {
                loading.fadeOut();
                success.fadeIn();
...
jQuery(document).ready(function($) {
    ...
    $("#mtaaReset").submit(function(event) {
...
jQuery(document).ready(function($) {
    ...
    mediaUpload: function () {
        ...
        $('input.upload_button').on("click", function () {
            ...
            mn.media.model.settings.post.id = $(this).attr('rel');

            uploader = mn.media.frames.mtaa_uploader = mn.media({
                'title' : 'Logo Image',
                'library' : {
                    'type' : 'image',
