...
<div class="wrap">
    <h2>More from Mtaa</h2>
    <ul class="inline">
        <li><a href="http://www.themes.mtaandao.co.ke/">More Themes</a></li>
        <li><a href="http://www.mtaandao.co.ke/support/">Support</a></li>
        <li><a href="http://www.mtaandao.co.ke/category/showcase/">Theme Showcase</a></li>
    </ul>
